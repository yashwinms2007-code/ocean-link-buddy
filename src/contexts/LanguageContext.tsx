...
const translations: Record<string, Record<Language, string>> = {
  ...
  phytoplanktonMapping:{ en: "Phytoplankton Mapping",       kn: "ಫೈಟೋಪ್ಲಾಂಕ್ಟನ್ ಮ್ಯಾಪಿಂಗ್",         hi: "फाइटोप्लांकटन मैपिंग" },
  thermalFrontsMap:   { en: "Thermal Fronts (SST)",        kn: "ಉಷ್ಣ ಮುಂಭಾಗಗಳು",                hi: "थर्मल फ्रंट (SST)" },
  oceanColorImg:      { en: "Ocean Color Imaging",         kn: "ಸಾಗರ ಬಣ್ಣ ಚಿತ್ರಣ",               hi: "महासागर रंग इमेजिंग" },
  bathymetricZone:    { en: "Bathymetric Zonation",        kn: "ಸಮುದ್ರ ಆಳ ವಲಯ",                  hi: "स्नानमितीय क्षेत्र" },
  phytoDesc:          { en: "NASA sensors detect Chlorophyll-a. Indicates primary food sources.", kn: "NASA ಸಂವೇದಕಗಳು ಕ್ಲೋರೊಫಿಲ್ ಅನ್ನು ಪತ್ತೆ ಮಾಡುತ್ತವೆ.", hi: "NASA सेंसर क्लोरोफिल-ए का पता लगाते हैं।" },
  thermalDesc:        { en: "Where currents meet, 'Fronts' trap nutrients based on temperature.", kn: "ಉಷ್ಣತೆಯ ಆಧಾರದ ಮೇಲೆ ಮೀನುಗಳನ್ನು ಆಕರ್ಷಿಸುವ ವಲಯಗಳು.", hi: "जहां धाराएं मिलती हैं, वहां तापमान के आधार पर." },
  colorDesc:          { en: "Biological activity changes water color, mapped via satellites.", kn: "ಜೈವಿಕ ಚಟುವಟಿಕೆ ನೀರಿನ ಬಣ್ಣವನ್ನು ಬದಲಾಯಿಸುತ್ತದೆ, ಇದನ್ನು ಅಳೆಯಲಾಗುತ್ತದೆ.", hi: "जैविक गतिविधि पानी का रंग बदलती है।" },
  bathyDesc:          { en: "Fish are habitat-specific. Models predict zones using depth charts.", kn: "ಆಳದ ಆಧಾರದ ಮೇಲೆ ಮೀನುಗಳು ಇರುವ ಪ್ರದೇಶಗಳ ನಕ್ಷೆ.", hi: "गहराई चार्ट का उपयोग करके जोन की भविष्यवाणी।" },
  filterActive:       { en: "Filter Active",               kn: "ಫಿಲ್ಟರ್ ಸಕ್ರಿಯವಾಗಿದೆ",            hi: "फ़िल्टर सक्रिय" },

  // Deep FishDetection Translations
  satelliteSync:      { en: "Satellite Sync",              kn: "ಉಪಗ್ರಹ ಹೊಂದಾಣಿಕೆ",             hi: "सैटेलाइट सिंक" },
  pfzDesc:            { en: "Potential Fishing Zones predicted via multi-parameter modeling.", kn: "ಬಹು-ಪ್ಯಾರಾಮೀಟರ್ ಮೂಲಕ ಸಂಭಾವ್ಯ ಮೀನುಗಾರಿಕಾ ವಲಯಗಳ ಭವಿಷ್ಯ.", hi: "मल्टी-पैरामीटर मॉडलिंग के माध्यम से संभावित मछली पकड़ने के क्षेत्र।" },
  liveSatellite:      { en: "LIVE SATELLITE",              kn: "ಲೈವ್ ಉಪಗ್ರಹ",                  hi: "लाइव सैटेलाइट" },
  offlineEngine:      { en: "OFFLINE ENGINE",              kn: "ಆಫ್‌ಲೈನ್ ಎಂಜಿನ್",               hi: "ऑफ़लाइन इंजन" },
  syncing:            { en: "Syncing...",                  kn: "ಸಿಂಕ್ ಆಗುತ್ತಿದೆ...",            hi: "सिंक हो रहा है..." },
  forceSync:          { en: "Force Sync",                  kn: "ಬಲವಂತವಾಗಿ ಸಿಂಕ್ ಮಾಡಿ",         hi: "फोर्स सिंक" },
  lastSyncPrefix:     { en: "Last:",                       kn: "ಕೊನೆಯದಾಗಿ:",                  hi: "अंतिम:" },
  yourVessel:         { en: "Your Vessel",                 kn: "ನಿಮ್ಮ ನೌಕೆ",                   hi: "आपका जहाज" },
  pfzHotspot:         { en: "PFZ Hotspot",                 kn: "PFZ ವಲಯ",                      hi: "PFZ हॉटस्पॉट" },
  confidence:         { en: "Confidence",                  kn: "ನಂಬಿಕೆ",                       hi: "विश्वास" },
  score:              { en: "Score",                       kn: "ಅಂಕಗಳಿಕೆ",                     hi: "स्कोर" },
  vesselStatusOnline: { en: "Vessel Status: Online Sync",  kn: "ನೌಕೆಯ ಸ್ಥಿತಿ: ಲೈವ್",           hi: "जहाज की स्थिति: लाइव" },
  vesselStatusOffline:{ en: "Vessel Status: Offline Mode", kn: "ನೌಕೆಯ ಸ್ಥಿತಿ: ಆಫ್‌ಲೈನ್",        hi: "जहाज की स्थिति: ऑफ़लाइन" },
  hudHotspot:         { en: "Hotspot",                     kn: "ಹಾಟ್‌ಸ್ಪಾಟ್",                   hi: "हॉटस्पॉट" },
  hudModerate:        { en: "Moderate",                    kn: "ಮಧ್ಯಮ",                       hi: "मध्यम" },
  hudFront:           { en: "Front",                       kn: "ಮುಂಭಾಗ",                      hi: "मुकाबला" },
  zoneAnalytics:      { en: "Zone Analytics",              kn: "ವಲಯ ವಿಶ್ಲೇಷಣೆ",                 hi: "ज़ोन विश्लेषण" },
  targetLabel:        { en: "Target",                      kn: "ಗುರಿ",                         hi: "लक्ष्य" },
  biologicalInsight:  { en: "Biological Insight",          kn: "ಜೈವಿಕ ಒಳನೋಟ",                  hi: "जैविक अंतर्दृष्टि" },
  sourceLabel:        { en: "Source",                      kn: "ಮೂಲ",                         hi: "स्रोत" },
  safetyFactor:       { en: "Safety Factor",               kn: "ಸುರಕ್ಷತಾ ಅಂಶ",                  hi: "सुरक्षा कारक" },
  safeForDeployment:  { en: "SAFE FOR DEPLOYMENT",         kn: "ಹೋಗಲು ಸುರಕ್ಷಿತ",                 hi: "जाने के लिए सुरक्षित" },
  cautionWaveDrift:   { en: "CAUTION: WAVE DRIFT",         kn: "ಎಚ್ಚರಿಕೆ: ಅಲೆಗಳ ಅಲೆತ",          hi: "चेतावनी: लहर का बहाव" },
  predictedSpecies:   { en: "Predicted Species",           kn: "ಊಹಿಸಿದ ಮೀನುಗಳು",                hi: "अनुमानित मछली" },
  navigationTelemetry:{ en: "Navigation Telemetry",        kn: "ನ್ಯಾವಿಗೇಶನ್ ಟೆಲಿಮೆಟ್ರಿ",          hi: "नेविगेशन टेलीमेट्री" },
  habitatLabel:       { en: "Habitat",                     kn: "ಆವಾಸಸ್ಥಾನ",                     hi: "प्राकृतिक वास" },
  travelTime:         { en: "travel",                      kn: "ಪ್ರಯಾಣ",                       hi: "यात्रा" },
  modelConfidence:    { en: "Confidence",                  kn: "ವಿಶ್ವಾಸಾರ್ಹತೆ",                  hi: "आत्मविश्वास" },
  sstLabel:           { en: "SST",                         kn: "ಉಷ್ಣತೆ",                       hi: "तापमान" },
  planktonLabel:      { en: "Plankton",                    kn: "ಪ್ಲಾಂಕ್ಟನ್",                   hi: "प्लवक" },
  currentLabel:       { en: "Current",                     kn: "ಪ್ರವಾಹ",                       hi: "समुद्री लहरें" },
  colorLabel:         { en: "Color",                       kn: "ಬಣ್ಣ",                         hi: "रंग" },
  sstBasis:           { en: "Ideal: 26-28.5°C",            kn: "ಆದರ್ಶ: 26-28.5°C",               hi: "आदर्श: 26-28.5°C" },
  planktonBasis:      { en: "High Food Prob",              kn: "ಹೆಚ್ಚಿನ ಆಹಾರ",                  hi: "उच्च भोजन" },
  currentBasis:       { en: "Collision Zone",              kn: "ಸಂಗಮ ವಲಯ",                    hi: "टकराव क्षेत्र" },
  colorBasis:         { en: "Bio-Activity",                kn: "ಜೈವಿಕ ಚಟುವಟಿಕೆ",                hi: "जैव-गतिविधि" },
  
  // Advanced Telemetry Metrics
  salinityLabel:      { en: "Salinity",                    kn: "ಲವಣಾಂಶ",                       hi: "खारापन" },
  salinityBasis:      { en: "Ideal: 34.5-35.5ppt",         kn: "ಆದರ್ಶ: 34.5-35.5ppt",          hi: "आदर्श: 34.5-35.5ppt" },
  thermoclineLabel:   { en: "Thermocline",                 kn: "ಥರ್ಮೋಕ್ಲೈನ್",                  hi: "थर्मोक्लाइन" },
  thermoclineBasis:   { en: "Ideal Barrier",               kn: "ಆದರ್ಶ ತಡೆಗೋಡೆ",                  hi: "आदर्श बाधा" },
  turbidityLabel:     { en: "Turbidity",                   kn: "ಮಬ್ಬು",                        hi: "गंदलापन" },
  turbidityBasis:     { en: "Clear Water",                 kn: "ಸ್ಪಷ್ಟ ನೀರು",                    hi: "साफ पानी" },
  moonPhaseLabel:     { en: "Moon Phase",                  kn: "ಚಂದ್ರನ ಹಂತ",                    hi: "चंद्रमा का चरण" },
  moonPhaseBasis:     { en: "Tidal Pull",                  kn: "ಉಬ್ಬರವಿಳಿತ",                    hi: "ज्वारीय खिंचाव" },

  selectZoneHint:     { en: "Select a zone hotspot on the map to begin analysis", kn: "ವಿಶ್ಲೇಷಣೆ ಪ್ರಾರಂಭಿಸಲು ನಕ್ಷೆಯಲ್ಲಿ ವಲಯವನ್ನು ಆಯ್ಕೆಮಾಡಿ", hi: "विश्लेषण शुरू करने के लिए मानचित्र पर एक ज़ोन चुनें" },
  activeHotspots:     { en: "Active Hotspots",             kn: "ಸಕ್ರಿಯ ವಲಯಗಳು",                 hi: "सक्रिय हॉटस्पॉट" },
  regionSync:         { en: "Region Sync",                 kn: "ಪ್ರದೇಶದ ಸಿಂಕ್",                 hi: "क्षेत्र सिंक" },
  probLabel:          { en: "Prob",                        kn: "ಸಾಧ್ಯತೆ",                      hi: "संभावना" },
  trainingLabel:      { en: "Training...",                 kn: "ತರಬೇತಿ...",                    hi: "सिखाना..." },
  scienceTitle:       { en: "The Science of PFZ",          kn: "ವಲಯದ ವಿಜ್ಞಾನ",                   hi: "ज़ोन का विज्ञान" },
  scienceDesc:        { en: "Our AI models analyze multiple satellite layers to identify where fish gather.", kn: "ಮೀನುಗಳು ಎಲ್ಲಿ ಸೇರುತ್ತವೆ ಎಂಬುದನ್ನು ನಮ್ಮ AI ಮಾದರಿಗಳು ವಿಶ್ಲೇಷಿಸುತ್ತವೆ.", hi: "हमारे AI मॉडल विश्लेषण करते हैं कि मछलियां कहां जमा होती हैं।" },
  mlEngine:           { en: "Machine Learning Pattern Engine", kn: "ಯಂತ್ರ ಕಲಿಕಾ ಮಾದರಿ ಎಂಜಿನ್", hi: "मशीन लर्निंग पैटर्न इंजन" },
  mlTrainingViz:      { en: "Neural Network Training Visualization", kn: "ನ್ಯೂರಲ್ ನೆಟ್‌ವರ್ಕ್ ದೃಶ್ಯೀಕರಣ", hi: "न्यूरल नेटवर्क विज़ुअलाइज़ेशन" },
  step1Title:         { en: "Input Sat Data",              kn: "ಉಪಗ್ರಹ ಡೇಟಾ",                  hi: "सैटेलाइट डेटा" },
  step1Desc:          { en: "Raw Sea Surface Temp (SST) & Chlorophyll imagery processed globally.", kn: "ಸಮುದ್ರದ ಉಷ್ಣತೆ ಮತ್ತು ಕ್ಲೋರೋಫಿಲ್ ಅನ್ನು ಪ್ರಕ್ರಿಯೆಗೊಳಿಸಲಾಗಿದೆ.", hi: "समुद्र का तापमान और क्लोरोफिल." },
  step2Title:         { en: "Continuous Training",         kn: "ನಿರಂತರ ತರಬೇತಿ",                 hi: "निरंतर प्रशिक्षण" },
  step2Desc:          { en: "Model validates satellite data against historical & live catch logs.", kn: "ಮಾದರಿಗಳನ್ನು ನೈಜ ಡೇಟಾದೊಂದಿಗೆ ಮೌಲ್ಯೀಕರಿಸುತ್ತದೆ.", hi: "लाइव कैच लॉग के खिलाफ डेटा को मान्य करता है।" },
  step3Title:         { en: "Learned Patterns",            kn: "ಕಲಿತ ಮಾದರಿಗಳು",                 hi: "सीखे गए पैटर्न" },
  step3Prefix:        { en: "Fish appear when",            kn: "ಮೀನು ಕಾಣಿಸಿಕೊಳ್ಳುವುದು:",            hi: "मछली दिखाई देती है:" },
  zonesRespecting:    { en: "Zones Respecting Criteria",   kn: "ವಲಯಗಳ ಹೊಂದಾಣಿಕೆ",                 hi: "मापदंड का सम्मान करने वाले ज़ोन" },
  multimodalWeighting:{ en: "Multimodal Algorithm Weighting", kn: "ಮಲ್ಟಿಮೋಡಲ್ ಅಲ್ಗಾರಿದಮ್ ತೂಕ", hi: "मल्टीमॉडल एल्गोरिदम वेटिंग" },
  modelAccuracyFactor:{ en: "Model Accuracy Factor",       kn: "ಮಾದರಿ ನಿಖರತಾ ಅಂಶ",               hi: "मॉडल सटीकता कारक" }
};
